...
.lp-book-title {
  font-size: 14px; font-weight: 700; color: #2D5228; line-height: 1.3;
}
.lp-book-author {
  font-size: 11px; color: #7A9B5A; margin-top: 2px; font-weight: 500;
}
...
.lp-news-btn {
  ...
  font-size: 14px;
  font-weight: 700;
  color: var(--news-color, #2D5228);
  transition: all .15s;
}
.lp-news-btn:hover {
  background: rgba(255,255,255,0.95);
  border-color: var(--news-color, #2D5228);
...
console.log('Done. CSS file:', size, 'bytes');
